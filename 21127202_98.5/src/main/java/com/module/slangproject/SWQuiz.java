...
public class SWQuiz {
    ...
    String question = slangWord.getRandomSlang();
    String answer = slangWord.getDefinitionsAsString(question);
    ...
    {
        question = slangWord.getRandomSlang();
        answer = slangWord.getDefinitionsAsString(question);
        ...
        for (int i = 0; i < 4; i++){
            if (i == ran){
                ...
                if (i == 0){
                    radio01.setText(slangWord.getDefinitionsAsString(slangWord.getRandomSlang()));
                }
                else if (i == 1){
                    radio02.setText(slangWord.getDefinitionsAsString(slangWord.getRandomSlang()));
                }
                else if (i == 2){
                    radio03.setText(slangWord.getDefinitionsAsString(slangWord.getRandomSlang()));
                }
                else if (i == 3){
                    radio04.setText(slangWord.getDefinitionsAsString(slangWord.getRandomSlang()));
                }
            }
        }
    }
